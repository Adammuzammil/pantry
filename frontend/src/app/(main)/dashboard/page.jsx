  ...
  return (
    <div className="min-h-screen bg-stone-50 py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-5">
          <h1
            className="text-5xl md:text-7xl font-medium text-stone-900
          mb-4 tracking-tight leading-tight"
          >
            Fresh Recipes, Made for you
          </h1>
          <p className="text-xl text-stone-600 font-light max-w-2xl">
            Discover curated recipes from around the world. Cook smarter, create
            effortlessly, and enjoy every bite.
          </p>
        </div>
