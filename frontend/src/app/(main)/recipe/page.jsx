            ...
            <div className="mt-8 max-w-md mx-auto">
              <div className="flex items-center gap-3 text-sm text-stone-500">
                <div className="flex-1 h-1 bg-stone-200 overflow-hidden relative">
                  <div className="absolute left-0 top-0 h-full w-0 bg-orange-600 animate-slow-fill" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-white p-8 md:p-10 border-2 border-stone-200 mb-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <PDFDownloadLink
                document={
                  <DownloadPDF recipe={recipe} isPro={recipeData.isPro} />
                }
            ...
            <div className="bg-white p-8 border-2 border-stone-200">
              ...
              <div>
                {recipe.instructions.map((step, index) => (
                  ...
                  >
                    {/* Step Number */}
                    <div className="absolute -left-5 top-0 w-10 h-10 text-white flex items-center justify-center font-bold bg-orange-600 border-2 border-orange-700">
                      {step.step}
                    </div>
...
const RecipePage = () => {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-stone-50 pt-24 pb-16 px4">
